/**
 * Glass Shatter Effect - Полностью готовая монолитная версия
 * Интерактивный эффект разбивающегося стекла с 2D трещинами и 3D физикой
 * 
 * Управление:
 * - Ctrl + Alt + Клик: взрыв в точке клика
 * - Alt + H: взрыв из центра экрана
 * 
 * Требования: html2canvas, Three.js (подгружаются автоматически)
 */
...
(function () {
    ...
    // ==================== ТРИАНГУЛЯЦИЯ ДЕЛОНЕ (ИСПРАВЛЕННАЯ) ====================
    class Delaunay {
        constructor(points) {
            this.points = points;
            this.triangles = [];
