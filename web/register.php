...
<head>
    ...
    <title>Регистрация · Votely</title>
        ...
        <main class="creator">
            <section class="creator__panel" style="max-width: 450px; margin: 0 auto;">
                <div class="creator__header">
                    <p class="creator__eyebrow">Новый аккаунт</p>
                    <h1 class="creator__title">Регистрация</h1>
                </div>

                <form id="register-form" class="creator-form" style="margin-top: 24px;">
                    <div class="field" style="margin-bottom: 20px;">
                        <label class="field__label" for="name">Имя</label>
                        <input type="text" id="name" name="name" class="field__control" placeholder="Иван Иванов" required>
                    </div>
                    ...
                    <div class="field" style="margin-bottom: 20px;">
                        ...
                        <p style="margin-top: 6px; font-size: 13px; color: #6b6e73;">Минимум 6 символов</p>
                    </div>
                    ...
                    <p class="auth-switch-text" style="text-align: center; color: #6b6e73; font-size: 15px;">
                        Уже есть аккаунт? <a href="login.php" style="color: var(--green); text-decoration: none; font-weight: 700;">Войти</a>
                    </p>
                </form>
            </section>
        </main>
