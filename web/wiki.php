                    ...
                    <article class="wiki__article">
                        <section class="wiki__section" id="about">
                            ...
                            <p class="wiki__text">
                                ...
                                друзей интерактивными вопросами. Регистрация для голосования не обязательна.
                            </p>
                        </section>
                        ...
                        <section class="wiki__section" id="faq">
                            ...
                            <p class="wiki__text">
                                Для прохождения опросов и викторин регистрация не нужна. Для создания и
                                управления своими опросами достаточно войти через Telegram или почту.
                            </p>

                            <h3 class="wiki__question">Сколько вопросов можно добавить?</h3>
                            <p class="wiki__text">
                                Жёсткого ограничения нет: добавляйте столько вопросов и вариантов,
                                сколько нужно для вашей задачи.
                            </p>

                            <h3 class="wiki__question">Можно ли изменить опрос после создания?</h3>
                            <p class="wiki__text">
                                Да, на странице «Мои опросы» доступны управление и редактирование
                                созданных опросов и викторин.
                            </p>
                        </section>
                    </article>
                </div>
